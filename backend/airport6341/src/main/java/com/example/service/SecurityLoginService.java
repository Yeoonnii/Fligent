...
public class SecurityLoginService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) 
        ...
        System.out.println("SecurityLoginService 입력한 username ==> " + username);
        ...
        // System.out.println("---------SecurityLoginService MEMBER DB에서 찾은 데이터!!!!!!!!!!!11 -----------");
        ...
        if(member != null && member.getBlock() == 0) {
            ...
            // System.out.println("------------ SecurityLoginService USER -----------");
