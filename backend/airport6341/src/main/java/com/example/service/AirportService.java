...
public class AirportService {
    ...
    public JSONArray weatherGET(String nx, String ny) {
        try {
            ...
            for(int i = 0; i<10; i++){
                ...
                // System.out.println("nx : " + nx); // 예보지점의 X 좌표값
                // System.out.println("ny : " + ny); // 예보지점의 Y 좌표값
    ...
    public JSONObject getwaittime(String cate) {
        try {
            ...
            // System.out.println("parseResponse TYPE  "+parseResponse.isEmpty());

            if(parseResponse.isEmpty() != true){
                System.out.println("null이 아닌경우");
            ...
            // JSONObject parsedata = (JSONObject) parseResponse.get("data");
            ...
            // System.out.println(result.get("IATA_APCD"));
            // System.out.println(result.get("STY_TCT_AVG_ALL"));
