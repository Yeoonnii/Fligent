...
public class MemberRestController {
    ...
    public Map<String,Object> findIdGET(
        ...
        // System.out.println(member1); // 들어옴
    ...
    public Map<String, Object> findpasswordGET(
        ...
        try {
            ...
            if (member != null) { // db정보에 회원정보가 있다면
                ...
                // System.out.println("RestCode =============>" + code);
                if (code != null) {
                    map.put("status", 200);
                    map.put("code", code);
                }
    ...
    public Map<String, Object> setNewPwGET(
        ...
        try {
            ...
            // System.out.println("DB에서 조회된 회원정보" + member);
            if (member != null) { // db정보에 회원정보가 있다면
    ...
    public Map<String, Object> loginPOST(@RequestBody Member member) {
        ...
        try {
            ...
            UsernamePasswordAuthenticationToken token1 = new UsernamePasswordAuthenticationToken(member.getUserid(), member.getUserpw(), role);
