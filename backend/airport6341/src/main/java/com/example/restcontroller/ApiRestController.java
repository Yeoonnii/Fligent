...
public class ApiRestController {
    ...
    public List<WeatherDTO> flightInfoGET(@RequestParam(name = "schAirCode") String schAirCode) {
        try {
            ...
            // System.out.println("schAirCode : " + schAirCode);
            ...
            // System.out.println("=====================weatherinfo RestController=====================");
    ...
    public getWaitTimeDTO getwaittimeGET(
        ...
        try {
            ...
            JSONObject flightstatuslist = aService.getwaittime(cate);
                System.out.println("*******ApiRestController 에서 반환받은 return 값*********" + flightstatuslist);
            ...
            if(flightstatuslist != null){ // AirportService 에서 반환받은 값이 null이 아닌 경우
                ...
                // System.out.println(Math.round(all/60)); //전체 구간 소요시간 평균
                // System.out.println(Math.round(a/60)); // 탑승권자동발권-수하물위탁-신분확인
                // System.out.println(Math.round(b/60)); //신분확인-보안검색-탑승시간
                // System.out.println(Math.round(c/60)); //보안검색-탑승시간
                // System.out.println(Math.round(d/60)); //탑승시간-출발
    ...
    public String incheonParkingInfoGET(
        ...
        try {
            ...
            // System.out.println(incheonparkinginfo);
    ...
    public Map<String,Object> AirportLeaseContractInfo( 
        ...
        try {
            ...
            // System.out.println(airportleasecontractinfo.toString());
            ...
            // System.out.println(airportStoreListDTO1);
