    ...
    <div class="container">
      <div class="traffic">
        <div class="row">
          ...
          <div class="col-6">
            <h2>공항 주차장 혼잡도</h2>
            <el-descriptions direction="vertical" v-for="obj of state.parkinginfodata.slice(0, 6)" :key="obj" border="1" style="width: 90%; margin-top: 30px; height: 50px; margin-right: 100px;">
  ...
  export default {
      setup () {
        ...
        const handleData1 = async() => {
          const url = `/ROOT/api/airportstore/selecttypeofbussiness.json?airportCode=ICN&typeOfBusiness=${state.typeofbusiness}&start=${state.page}`;
