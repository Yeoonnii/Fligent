    ...
    <div class="traffic">
      <div class="row">
        <div class="col-6">
          ...
          <div id="map" style="border-radius: 25px; border: 2px solid; width:550px; height: 500px; margin-left: 100px;"></div>
        </div>
        <div class="col-6">
          <div class="text-box">
            <h2 style="margin-bottom: 50px;">공항 주차장 혼잡도</h2>
          </div>
          <el-descriptions direction="vertical" v-for="obj of state.parkinginfodata" :key="obj" border="1" style="width: 90%; margin: auto; height: 185px; margin-right: 100px;" >
          ...
          <div class="row">
            ...
            <div class="col" style="margin-right: 20px;">
              ...
              <div style="margin-top: 15%">
                <el-button color="#F2D1C9" round>#먹거리</el-button>
                <el-button color="#032859" round>#놀거리</el-button>
                <el-button color="#F2D1C9" round>#행사</el-button>
                <br/>
                <el-button color="#032859" round>#명소</el-button>
                <el-button color="#F2D1C9" round>#가족</el-button>
                <br />
                <el-button color="#032859" round>#친구</el-button>
                <el-button color="#F2D1C9" round>#연인</el-button>
                <el-button color="#032859" round>#신혼</el-button>
              </div>
            </div>
          </div>
        </div>
...
export default {
    setup () {
      ...
      const handleData = async() => {
        ...
        const url3 = `/ROOT/api/parkinginfo.json?cate=${state.cate}`;
      ...
      const handleData1 = async() => {
        const url = `/ROOT/api/airportstore/selecttypeofbussiness.json?airportCode=CJU&typeOfBusiness=${state.typeofbusiness}&start=${state.page}`;
        const headers = {"Content-Type":"application/json"};
        const {data} = await axios.get(url, {headers});
        console.log(data);
        if(data.status === 200){
...
.header h1{
  ...
  text-shadow: 1px 2px 2px rgb(197, 121, 121);
  font-size: 55px;
}
.el-button{
  margin-bottom: 10%; 
